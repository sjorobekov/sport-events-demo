      ...
      <template #actions>
        ...
        >
          ...
          <v-list>
            ...
            >
              <v-list-item-title class="neutral--text text--darken-3">Edit Announcement</v-list-item-title>
            </v-list-item>
            <v-list-item @click="removeHandler">
              <v-list-item-title class="neutral--text text--darken-3">Delete Announcement</v-list-item-title>
            </v-list-item>
          </v-list>
        </v-menu>
        <v-btn
